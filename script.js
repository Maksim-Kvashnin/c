...
header.onclick = e => {
  ...
  document.getElementById(localStorage.day).classList.toggle('active');
  table(2);
}
...
document.getElementById(localStorage.day).classList.add('active');
let letterWorkShift = document.querySelector('.workShift'); // 
letterWorkShift.addEventListener('click', e => {
  view = true;
  if (!e.target.classList.contains('active')) {
    document.getElementById(localStorage.day).classList.remove('active');
